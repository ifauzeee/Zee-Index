      ...
      <main className="relative flex-1 flex items-center justify-center px-6">
        <div className="w-full max-w-lg">
          <div className="flex items-center gap-4 mb-10">
            <div className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-medium transition-all ${step >= 1 ? "bg-blue-500 text-white" : "bg-muted text-muted-foreground"}`}>
              1
            </div>
            <div className={`flex-1 h-0.5 transition-all ${step >= 2 ? "bg-blue-500" : "bg-border"}`} />
            <div className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-medium transition-all ${step >= 2 ? "bg-blue-500 text-white" : "bg-muted text-muted-foreground"}`}>
              2
            </div>
          </div>
          ...
          {step === 1 ? (
            <div className="space-y-8">
              <div>
                <h2 className="text-2xl font-semibold mb-2">Koneksi Google Drive</h2>
                <p className="text-muted-foreground">
                  Masukkan kredensial dari Google Cloud Console untuk menghubungkan aplikasi dengan Google Drive Anda.
                </p>
              </div>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Ambil dari URL: drive.google.com/drive/folders/<span className="text-blue-500 font-mono">FOLDER_ID</span>
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-8">
              <div className="flex flex-col items-center text-center">
                ...
                <h2 className="text-2xl font-semibold mb-2">Otorisasi Berhasil!</h2>
                <p className="text-muted-foreground max-w-sm">
                  Kode otorisasi telah diterima. Klik tombol di bawah untuk menyelesaikan proses setup.
                </p>
              </div>
              ...
              <div className="p-4 rounded-xl bg-muted/50 border border-border/50">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Proses ini akan menukar kode otorisasi dengan token akses dan menyimpannya ke database serta file .env.
                  </p>
                </div>
              </div>
