...
import { Bell, Check, X, Trash2, Info, CheckCircle2, XCircle } from "lucide-react";
                ...
                notifications.map((notif) => (
                  <div
                    ...
                    className={`p-4 rounded-lg border border-border bg-card relative ${
                      !notif.read ? "bg-accent/10 border-l-4 border-l-primary" : ""
                    }`}
                  >
                    <div className="flex gap-3 items-start">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xs text-muted-foreground mt-2">
                          {format(notif.timestamp, "dd MMM HH:mm", { locale: localeId })}
                        </p>
                      </div>
                    </div>
                  </div>
