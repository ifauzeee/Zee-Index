...
export default function AudioPlayer({ src, title, mimeType, poster }: AudioPlayerProps) {
    ...
    return (
        <div className="relative w-full h-full bg-zinc-950 flex flex-col items-center justify-center p-6 space-y-8 overflow-hidden rounded-xl">
            ...
            <style jsx global>{`
        :root {
          --primary-rgb: 59, 130, 246; /* Default blue, will be overridden by theme if needed */
        }
        .dark {
