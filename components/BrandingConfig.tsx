...
export default function BrandingConfig() {
  ...
  if (isConfigLoading) return <div className="flex justify-center p-8"><Loader2 className="animate-spin" /></div>;

  return (
    <div>
      <h2 className="text-2xl font-semibold mb-6">Custom Branding (White Label)</h2>
