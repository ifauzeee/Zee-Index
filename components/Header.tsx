...
import { Sun, Moon, RefreshCw, Send, Coffee, HardDrive, Search as SearchIcon, Menu, LogIn, LogOut, ArrowLeft, ShieldCheck, Star, Github } from 'lucide-react'; 
...
export default function Header() {
    ...
    const menuItems = [
        ...
        { id: 'github', href: 'https://github.com/ifauzeee/Zee-Index', target: '_blank', rel: 'noopener noreferrer', icon: Github, label: 'GitHub' },
    ...
    const publicShareLinkItems = ['storage', 'theme', 'refresh', 'github', 'telegram', 'donate'];
