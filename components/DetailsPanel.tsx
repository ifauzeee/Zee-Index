...
import { motion, PanInfo, useAnimation, AnimatePresence, Variants } from "framer-motion";
import {
  X,
  Plus,
  Tag as TagIcon,
  ...
  return (
    <>
      ...
      >
        ...
        >
          <motion.div variants={itemVariants} className="flex flex-col items-center gap-6 pt-2">
          ...
          <motion.div variants={itemVariants} className="space-y-4 bg-card/30 rounded-2xl p-2 border border-border/30">
            <div className="flex items-center gap-2 px-2 pb-2 border-b border-border/30">
              <History size={16} className="text-primary" />
              <h4 className="text-xs font-bold uppercase tracking-wider text-muted-foreground">Properti File</h4>
            </div>
              ...
              {file.md5Checksum && (
                <div className="pt-4 px-2">
                  <div className="flex items-center gap-2 mb-2 text-muted-foreground">
                    <Hash size={14} />
                    <span className="text-xs font-bold uppercase">MD5 Checksum</span>
                  </div>
          ...
          <motion.div variants={itemVariants} className="space-y-3">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              {isAdmin && (
                ...
                >
                  <Plus size={14} className="text-muted-foreground mr-2 group-focus-within:text-primary transition-colors" />
                  <input
                    type="text"
                    value={newTag}
